...
aipUrl = get_apiUrl("/coupon/grant")
testData = get_csv_test_data("CouPon_grant_test_data.csv")


@ddt
class CouPon_grant(unittest.TestCase):
    def setUp(self):
       pass

    def tearDown(self):
        pass
        # r = requests.post(url=get_apiUrl("/coupon/me/list"),headers=headers,json={})
        #
        # print("=========================================")
        # print(r.json())
        # print("=========================================")
